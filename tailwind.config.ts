...
export default {
  darkMode: ["class"],
  // Tighten content scan to the only directory we actually have. The previous
  // list also globbed ./pages, ./components, ./app at the project root which
  // don't exist — wasted scan time on every build/HMR.
  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        hot: { DEFAULT: "hsl(var(--hot))", foreground: "hsl(var(--hot-foreground))", soft: "hsl(var(--hot-soft))" },
