...
app.post("/ai/reply-suggestions", requirePlan('growth', 'scale', 'enterprise'), async (c) => {
  ...
  if (isSalesmanAgent) {
    systemPrompt = [
      ...
      `Customer: "Price?" (if they specified ChatGPT) → Reply: "Plus ₹999 aur Pro ₹8999 sir 🙂"`,
      `Customer: "Price?" (if they specified Claude) → Reply: "₹1499 sir 🙂"`,
      ...
      `- 1-3 lines MAX (WhatsApp reseller style — extremely short)`,
